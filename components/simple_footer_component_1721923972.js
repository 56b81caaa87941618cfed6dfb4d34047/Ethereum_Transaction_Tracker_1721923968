...
*/
Vue.component("simple_footer_component_1721923972", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            EtherScan - Real-Time Ethereum Transactions
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Discover the latest Ethereum transactions as they happen. EtherScan provides up-to-the-minute monitoring of the Ethereum blockchain to help you stay informed.
                    </div>
                </div>
            </div>
        </footer> 
